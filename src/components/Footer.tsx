        ...
        <div className="footer-wrap">
          ...
          <div className={`brand text-center md:text-left`}>
            ...
            <div className="text-sm mt-2">
              ...
              <div className="mt-1">
                <a
                  href="/visitors"
                  className={`text-sky-700 hover:text-sky-800 underline underline-offset-4`}
                >
                  See visitor details
                </a>
              </div>
          ...
          <div className="socials">
            ...
            <a
              ...
              rel="noreferrer"
              aria-label="Facebook"
              className={`icon-link hover:text-blue-600`}
            >
            ...
            <a
              ...
              className={`icon-link hover:text-pink-600`}
            >
              <svg
                width="22"
                height="22"
            ...
            <a
              ...
              rel="noreferrer"
              aria-label="YouTube"
              className={`icon-link hover:text-red-600`}
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
            ...
            <a
              ...
              className={`icon-link hover:text-sky-600`}
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
            ...
            <a
              ...
              rel="noreferrer"
              aria-label="TikTok"
              className={`icon-link hover:text-black`}
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
          ...
          {/* Right: credits */}
          <div className={`credits text-center md:text-right text-xs text-gray-500`}>
            <div>© {new Date().getFullYear()} Museum xxx</div>
            <div>Designed by Nizam M.</div>
          </div>
        </div>
      </div>
    </footer>
